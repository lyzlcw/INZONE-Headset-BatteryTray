...
public class UsbCdcReader : IBatteryReader
{
    ...
    private static readonly byte[] BatteryQuery = [0x01, 0x00, 0xFC, 0x08, 0x96, 0xC3, 0x41, 0x04, 0x01, 0x01, 0x00, 0xA0];
    private static readonly byte[] Cmd01Status = [0x01, 0x00, 0xFC, 0x08, 0x96, 0xC3, 0x21, 0x01, 0x01, 0x01, 0x00, 0x7D];
    private static readonly byte[] Cmd02Init = [0x01, 0x00, 0xFC, 0x08, 0x96, 0xC3, 0x41, 0x02, 0x01, 0x01, 0x00, 0x9E];
